...
public class DarmaniNoPriceAdapter extends RecyclerView.Adapter<DarmaniNoPriceAdapter.UserViewHolder> {
    ...
    public DarmaniNoPriceAdapter(Context context, List<DarmaniModel> listPRO) {
            ...
            public void onClick(View v) {
                ...
                dialogView.findViewById(R.id.btn_order).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        databaseHelper.addNOpriceOrder(order);
                        alertDialog.dismiss();
    ...
    public int getItemCount() {
        Log.v(DarmaniNoPriceAdapter.class.getSimpleName(),""+listPRO.size());
        return listPRO.size();
    }
